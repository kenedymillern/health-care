        ...
        <div className="w-full bg-white">
            ...
            <section className="py-12 px-6 md:px-16 max-w-4xl mx-auto text-center">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
                    Set an appointment with the Eutriv Health Care Team
                </h2>
                <p className="text-gray-600 leading-relaxed mb-6">
                    Do you have a question? Eutriv Health Care is here to assist you. Inquire about our home care agency by
