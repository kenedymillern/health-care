...
export default function Header() {
  ...
  const contactItemVariants = {
    ...
    visible: { opacity: 1, scale: 1, transition: { type: "spring" as const, stiffness: 150 } },
    hover: { scale: 1.05, transition: { type: "spring" as const, stiffness: 200 } },
  };
  ...
  const navItemVariants = {
    ...
    hover: { scale: 1.05, color: '#D4AF37', transition: { type: 'spring' as const, stiffness: 300 } },
    tap: { scale: 0.95 },
  };
  ...
  const mobileMenuVariants = {
    ...
    open: {
      x: 0,
      opacity: 1,
      transition: { type: 'spring' as const, stiffness: 100, damping: 20, when: 'beforeChildren', staggerChildren: 0.1 },
    },
  };

  const hamburgerVariants = {
    closed: { rotate: 0, scale: 1 },
    open: { rotate: 90, scale: 1.1, transition: { type: 'spring' as const, stiffness: 200 } },
  };

  const logoVariants = {
    rest: { scale: 1, rotate: 0 },
    hover: { scale: 1.1, rotate: 5, transition: { type: 'spring' as const, stiffness: 200, damping: 10 } },
  };
